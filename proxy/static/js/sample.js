...
(function () {
  ...
  console.log(chrome, "sample.js");

  chrome.webRequest.onBeforeRequest.addListener(
    (detail) => {
      console.log(detail);
      sendMessage({ type: "getUrl", url: detail.url });
      // alert(chrome.extension.getURL("static/js/target.js"));
      // return { redirectUrl: chrome.extension.getURL("target.js") };
      return { cancel: true };
    },
